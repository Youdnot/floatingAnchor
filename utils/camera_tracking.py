# Originally from: grounded_sam2_tracking_hololens2_camera_with_continuous_id.py
# Modified for use as utility for detection from streaming source
...
class SAM2ImageSegmentor:
    ...
    def __init__(self, sam_model_cfg: str, sam_model_ckpt: str, device="cuda"):
        ...
        """
        from src.grounding_sam2.sam2.build_sam import build_sam2
        from src.grounding_sam2.sam2.sam2_image_predictor import SAM2ImagePredictor
